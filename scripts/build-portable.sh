...
echo ""
echo "To ship it: commit the release state, then  scripts/publish-release.sh"
echo "(tags v${version} if needed, pushes the tag, creates the GitHub release with"
echo "the CHANGELOG section as notes and the tarball attached)."
